...
class EnigmeControllerRo extends Controller
{
...
/**
   ...
   public function validE1(Request $request){
       ...
       $valider1 = $request->input('enigme1ro');
   ...
   public function validE2(Request $request){
       ...
       $valider2 = $request->input('enigme2ro');
   ...
   public function validE3(Request $request){
       ...
       $valider3 = $request->input('enigme3ro');
   ...
   public function validE4(Request $request){
       ...
       $valider4 = $request->input('enigme4ro');

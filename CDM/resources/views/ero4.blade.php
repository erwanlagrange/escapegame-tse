...
@section('content2')
	...
	<p style="margin-bottom: 20px">Entrer les initiales de ces mots dans le bon ordre pour débloquer la vidéo qui vous indiquera la suite de votre parcours.</p>
	        ...
	        <form action="{{ action('EnigmeControllerRo@validE4') }}" method="POST" > {{csrf_field()}}				
				<label for="enigme4ro">Mot de passe</label><br>
				<input id="enigme4ro" type="text" name="enigme4ro" placeholder="Votre réponse" style="margin-right:5px; margin-bottom:5px">
